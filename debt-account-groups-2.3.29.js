(function(){
  ...
  var style=document.createElement('style');style.textContent='.debt-group-create{width:100%;margin:0 0 12px}.debt-family{border:1px solid #d5b477;background:#fffaf0}.debt-family .item-main small{display:block}.debt-group-line{margin-top:4px;color:var(--muted)}.debt-group-line b{color:var(--text)}.debt-group-name{display:block;margin:-8px 0 12px;color:var(--muted)}.debt-card-open{display:flex;align-items:center;gap:10px;min-width:0;flex:1;cursor:pointer}.debt-link-person{border:1px solid var(--line);background:#fff;color:#8a6228;border-radius:10px;padding:8px;font-weight:700}.debt-group-sheet{max-height:92vh;overflow:auto}.debt-group-remove{display:block;width:100%;margin-top:18px;color:#a33f3a}.debt-customer{gap:10px}';document.head.appendChild(style);
})();
